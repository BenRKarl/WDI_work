...
thing1 = randomItem(thisArray);
thing2 = randomItem(thatArray);

function whatDoesYourStartupDo(item1, item2){
  var message = "So....your startup is basically like " + 
  item1 + " for " + item2 + "?";
  console.log(message);
}

whatDoesYourStartupDo(thing1, thing2);
