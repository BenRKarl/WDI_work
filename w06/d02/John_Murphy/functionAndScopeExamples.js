...
function addFunctionBuilder(numToAdd){
  var message = 'Where am I?';         //This line of code is kept in a closure because it's referenced in the return function.
...
// // After ^ makes sense... think about this:
...
setTimeout(function(){console.log('You are great')}, 3610000)
