...
PaletteView.prototype.render = function(){
  var $div  = $('<div>').addClass('palette');      //$ beore div is just a note that variable has a jQuery object
    ...
    $.ajax({
      ...
      success: function(data){
        $.each(data, function(i, datum){
          ...
          $('#palettes').append(paletteView.render().el) // append the "HeyPainter.PaintmeAPicture.ThisPicture"
        });
      }
    })
  }
