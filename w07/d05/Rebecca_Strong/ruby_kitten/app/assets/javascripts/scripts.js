...
// $(function(){
//   var kitten = $('<img>').attr('src', 'http://placekitten.com/200/300').addClass('kitten').draggable();
//   kitten.appendTo($('#kitten-bin')).hide().fadeIn(3000);

// $('#fade').droppable({
//   drop: function(e, dropped){
//     $(this).animate({backgroundColor: 'red'}, 500).animate({backgroundColor: 'green'}, 500);
