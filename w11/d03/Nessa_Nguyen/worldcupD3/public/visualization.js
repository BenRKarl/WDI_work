function buildSvg(data) {
  ...
  window.xAxisScale = d3.scale.linear().domain([maxGoalsAgainst+2, 0])
                     .range([0, width]);
  window.yAxisScale = d3.scale.linear().domain([maxGoalsFor+2, 0])
                     .range([0, height]);
  ...
  var xAxis = d3.svg.axis()
               .scale(window.xAxisScale).orient('bottom');
  var yAxis = d3.svg.axis()
               .scale(window.yAxisScale).orient('left');
