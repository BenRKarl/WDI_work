...
# three .txt documents and run this ruby file... after the binding.pry hits, call
# output_1(), output_2(), or output_3() to get the appropriate result. To test each
# output, run test_suite() (Note: Only the test for output_1 is complete).
...
def test_output_1
  ...
  results.each do |record_array|
    ...
    if record_array[2] != "Male" && record_array[2] != "Female"
      puts 'output_1 has something other than Male or Female'
    end
  end
