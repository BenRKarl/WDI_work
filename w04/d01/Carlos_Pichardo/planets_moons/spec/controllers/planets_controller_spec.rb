  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested planet" do
        ...
        Planet.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => planet.to_param, :planet => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the planet as @planet" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Planet.any_instance.stub(:save).and_return(false)
        put :update, {:id => planet.to_param, :planet => { "name" => "invalid value" }}, valid_session
        assigns(:planet).should eq(planet)
      end
