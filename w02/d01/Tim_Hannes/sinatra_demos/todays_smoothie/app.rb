...
# get '/smoothie/:num_of_ingredients' do
#   num_of_ingredients = 3
#   num_of_ingredients = params[:num_of_ingredients]
#   "<h2>Today's Smoothie: </h2>" + random_smoothie.join('<br>')
# end


# other way

# ingredient_array = smoothie_ingredients.map {|ingedient, measure| "#{ingredient}: #{measure}"}
