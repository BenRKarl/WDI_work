#Ben Karl Homework: Week 1, Day 2, Part 1
...
#Question 3:
firstnamelist.select { |name| name != "Muffintop"}

#Question 4:
lastnamelist.rindex "Gigglesnort"

#question 5:
puts firstnamelist[rand(firstnamelist.length)] + lastnamelist[rand(lastnamelist.length)]
