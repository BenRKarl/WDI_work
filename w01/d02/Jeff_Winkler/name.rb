...
# HWK Part1 Name Generator

# given array of first names
...
# 1. Retrieve "Bumblebee" from firstname list
puts firstnamelist[0]

# 2. Add "Matt" to firstnamelist
...
# 5. Combine 1 randomly selected name from firstnamelist and 1 randomly selected name from
#    lastnamelist to form a name.
