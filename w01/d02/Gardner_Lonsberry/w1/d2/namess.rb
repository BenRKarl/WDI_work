...
firstnamelist.each do |word|
  print word + " "
end

3.times { print "\n" }
puts "Found #{firstnamelist[0]}"

firstnamelist_with_matt = firstnamelist << "Matt"

puts firstnamelist_with_matt


3.times { print "\n" }
puts "Found #{firstnamelist[0]}"

last_name_hash = Hash[lastnamelist.map.with_index.to_a]
last_name_hash['Gigglesnort']


puts "Remove Muffintop from list? Y?"
redact_muffin = gets.chomp

if redact_muffin == "Yes"
  print " "
end
