...
describe Apartment do
  ...
  def new_apartment
    Apartment = Apartment.new('6F', 2400, 800, 2, 1)
  end
  ...
  it 'has a changeable number of batrooms' do
    apartment = new_apartment
 ...
 it 'tells you whether or not it is occupied' do
  ...
  it 'lets you add tenants' do
    apartment = new_apartment
    apartment.tenant << Object.new
    expect(apartment.occupied?).to

  it 'can describe itself' do
    apartment = new_apartment
    profile = '6F costs $2400 a month,  has 800 sqft, has 2 bedrooms and 1 bathrooms.'
    expect(apartmet.to_s).to eq profile
  end
end
